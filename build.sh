...
( docker logs -f burger-king_mysql 2>&1 & ) | grep -q "MySQL init process done. Ready for start up."
( docker logs -f burger-king_mysql 2>&1 & ) | grep -q "mysqld: ready for connections."
